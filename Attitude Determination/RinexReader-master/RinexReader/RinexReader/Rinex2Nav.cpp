...
void Rinex2Nav::readNav(std::ifstream& infile) {
	...
	for (const auto& prnDataPair : _navDataGPS) {
		int prn = prnDataPair.first; // PRN (key)
		const vector<Rinex2Nav::DataGPS>& navDataVector = prnDataPair.second; // DataGPS vector (value)

		// Print PRN
		cout << "PRN: " << prn << endl;

		// Iterate through DataGPS vector for this PRN
		for (const Rinex2Nav::DataGPS& navData : navDataVector) {
			// Print individual data fields of DataGPS
			cout << "Is Available: " << (navData.isAvailable ? "Yes" : "No") << endl;
			cout << "Epoch: " << navData.epochInfo[0] << " " << navData.epochInfo[1] << " " << navData.epochInfo[2] << " " << navData.epochInfo[3] << endl;
			cout << "GPS Time: " << navData.gpsTime << endl;
			cout << "Clock Bias: " << navData.clockBias << endl;
			cout << "Clock Drift: " << navData.clockDrift << endl;
			cout << "Clock Drift Rate: " << navData.clockDriftRate << endl;
			cout << "IODE: " << navData.IODE << endl;
			cout << "Crs: " << navData.Crs << endl;
			cout << "Dellta_n: " << navData.Delta_n << endl;
			cout << "Mo: " << navData.Mo << endl;
			cout << "Cuc: " << navData.Cuc << endl;
			cout << "Eccentricity: " << navData.Eccentricity << endl;
			cout << "Cus: " << navData.Cus << endl;
			cout << "Sqrt_a: " << navData.Sqrt_a << endl;
			cout << "TOE: " << navData.TOE << endl;
			cout << "Cic: " << navData.Cic << endl;
			cout << "OMEGA: " << navData.OMEGA << endl;
			cout << "Io: " << navData.Io << endl;
			cout << "omega: " << navData.Omega << endl;
			cout << "Omega_dot: " << navData.Omega_dot << endl;
			cout << "IDOT: " << navData.IDOT << endl;
			cout << "L2_codes_channel: " << navData.L2_codes_channel << endl;
			cout << "GL2_P_data_flag: " << navData.L2_P_data_flag << endl;
			cout << "GPS_week: " << navData.GPS_week << endl;
			cout << "svAccuracy: " << navData.svAccuracy << endl;
			cout << "TGD: " << navData.TGD << endl;
			cout << "IODC: " << navData.IODC << endl;


		}

		cout << "----------------------------------" << endl; // Separator between PRNs
	}
}
